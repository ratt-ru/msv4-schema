...
from msv4_schema.schema.metamodel import *
...
def value_schema(ann: typing.Any, klass_name: str, field_name: str) -> "ValueSchema":
    ...
    if isinstance(ann, type):
        # Array type?
        if hasattr(ann, "__msv4_schema_array_schema"):
            return ValueSchema("dataarray", array_schema=ann.__msv4_schema_array_schema)

        # Dictionary type?
        if hasattr(ann, "__msv4_schema_dict_schema"):
            return ValueSchema("dict", dict_schema=ann.__msv4_schema_dict_schema)
...
def xarray_dataclass_to_array_schema(klass):
    ...
    # Cached?
    if hasattr(klass, "__msv4_schema_array_schema"):
        return klass.__msv4_schema_array_schema
    ...
    klass.__msv4_schema_array_schema = schema
    return schema
...
def xarray_dataclass_to_dataset_schema(klass):
    ...
    # Cached?
    if hasattr(klass, "__msv4_schema_dataset_schema"):
        return klass.__msv4_schema_dataset_schema
    ...
    klass.__msv4_schema_dataset_schema = schema
    return schema
...
def xarray_dataclass_to_dict_schema(klass):
    ...
    This should work on any class annotated with :py:func:`~msv4_schema.schema.bases.dict_schema`
    """

    # Cached?
    if hasattr(klass, "__msv4_schema_dict_schema"):
        return klass.__msv4_schema_dict_schema
    ...
    klass.__msv4_schema_dict_schema = schema
    return schema

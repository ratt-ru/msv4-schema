...
class TimeArray:
    ...
    * ``gps`` (from 1980-01-06 00:00:00 UTC)
    ...
    """Time representation and epoch, see :py:class:`~msv4_schema.measurement_set.schema.TimeArray`."""
...
class TimeCoordArray:
    """Data model of the main dataset time axis. See also :py:class:`~msv4_schema.measurement_set.schema.TimeArray`."""

    data: Data[Time, float]
    """
    Time, expressed in seconds since the epoch (see ``scale`` &
    ``format``), see also see :py:class:`~msv4_schema.measurement_set.schema.TimeArray`.
    """
    ...
    scale: Attr[AllowedTimeScales] = "utc"
    """ Astropy time scales, see :py:class:`~msv4_schema.measurement_set.schema.TimeArray` """

    format: Attr[AllowedTimeFormats] = "unix"
    """ Astropy format, see :py:class:`~msv4_schema.measurement_set.schema.TimeArray`"""
...
class TimeInterpolatedCoordArray:
    ...
    time. See also :py:class:`~msv4_schema.measurement_set.schema.TimeArray`.
...
class VisibilityXds:
    ...
    see :py:class:`~msv4_schema.measurement_set.schema.TimeArray`. (MS v2: ``exposure``).
    """
    ...
    unlike the ``time`` coordinate, see :py:class:`~msv4_schema.measurement_set.schema.TimeArray`.
    """
